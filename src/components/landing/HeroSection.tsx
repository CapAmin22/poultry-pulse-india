          ...
          >
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Button 
                ...
                size="lg" 
                className="bg-white text-[#ea384c] hover:bg-gray-100 shadow-lg"
              >
                Get Started Free
          ...
          >
            ...
            <div className="relative z-10">
              <img 
                ...
                className="max-w-full h-auto max-h-[450px] object-contain drop-shadow-2xl"
              />
              <div className="absolute top-5 right-5 bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-lg">
                <div className="text-sm font-semibold text-[#ea384c]">Current Egg Price</div>
                <div className="text-2xl font-bold">₹5.20 <span className="text-green-500 text-sm">↑3.5%</span></div>
              </div>
              <div className="absolute bottom-5 left-5 bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-lg">
                <div className="text-sm font-semibold text-[#0FA0CE]">Daily Users</div>
                <div className="text-2xl font-bold">10,000+ <span className="text-green-500 text-sm">↑15%</span></div>
              </div>
            </div>
          </motion.div>
        </div>
