...
const MarketplaceShowcase: React.FC = () => {
  ...
  return (
    <section id="marketplace" className="bg-white py-20 px-4 sm:px-6">
          ...
          {marketplaceItems.map((item, index) => (
            ...
            >
              <div className="h-48 bg-gray-200 relative overflow-hidden">
                ...
                {item.trending && (
                  <div className="absolute top-3 right-3 bg-[#ea384c] px-2 py-1 rounded-md text-xs font-medium text-white flex items-center">
